    ...
    <div className="max-w-6xl mx-auto px-4 py-6 space-y-8">
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-2xl text-slate-900">Admin Scraper Dashboard</h2>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-slate-50 border-b border-slate-200">
              <tr>
                <th className="px-4 py-3 text-left text-sm text-slate-700">Card Name</th>
                <th className="px-4 py-3 text-left text-sm text-slate-700">Benefits</th>
                <th className="px-4 py-3 text-left text-sm text-slate-700">Frequency</th>
                <th className="px-4 py-3 text-left text-sm text-slate-700">Last Scraped</th>
                <th className="px-4 py-3 text-left text-sm text-slate-700">Auto-Rescrape</th>
              </tr>
            </thead>
                ...
                <tr key={card.id} className="hover:bg-slate-50">
                  <td className="px-4 py-3">
                    <div className="space-y-1">
                      <p className="text-sm text-slate-900">{card.name}</p>
                      <a
                        href={card.url}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xs text-slate-500 hover:underline truncate block max-w-xs"
                      >
                        {card.url}
                      </a>
                    </div>
